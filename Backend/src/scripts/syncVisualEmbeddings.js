/**
 * syncVisualEmbeddings.js
 * ───────────────────────
 * Batch-sync all active products (with images) to the Pinecone IMAGE index.
 *
 * Usage:
 *   npm run sync:visual
...
async function main() {
    console.log('┌─────────────────────────────────────────────┐');
    console.log('│  Pinecone Image (CLIP) Embedding Sync        │');
    console.log('└─────────────────────────────────────────────┘');
    console.log();
    ...
    const result = await pineconeService.batchSyncImageEmbeddings({ force: false });
